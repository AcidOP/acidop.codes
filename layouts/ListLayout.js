      ...
      <div className="divide-y divide-gray-700">
        <div className="space-y-2 pb-8 md:space-y-5">
          <h1 className="tracking-tighttext-gray-100 text-3xl font-extrabold leading-9 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
            ...
            <span className="text-primary-500">({posts.length})</span>
          </h1>
        ...
        <ul>
          ...
          {displayPosts.map((frontMatter) => {
            ...
            summary.length > 150 ? (summary = summary.substring(0, 150).trim() + ' ...') : summary
              ...
              >
                <article className="space-y-2  p-2 xl:grid xl:grid-cols-4 xl:items-baseline xl:space-y-0">
                  ...
                  <div className="flex flex-col space-y-3 xl:col-span-3">
                    ...
                    <Link href={`/blog/${slug}`} className="text-primary-500">
                      Read more &rarr;
                    </Link>
                  </div>
                </article>
